...
import cn.zhudai.zin.css.utils.StringUtils;
...
public class ShowProtocolActivity extends BaseActivity {
    ...
    String content="<div class=\"agreement-main fz16\">\n" +
            "<p><br></p>\n"+
            " <p class=\"fz18\">一、总则</p>\n" +
            " <p>1.1 助贷网客服系统的所有权和运营权归深圳前海小微贷发展有限公司所有。</p>\n" +
            " <p>1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与助贷网之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。</p>\n" +
            " <p>1.3 本协议则可由助贷网随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。</p>\n" +
            " <p class=\"fz18\">二、服务内容</p>\n" +
            " <p>2.1 助贷网客服系统的具体内容由本站根据实际情况提供。</p>\n" +
            " <p>2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。</p>\n" +
            " <p class=\"fz18\">三、用户帐号</p>\n" +
            " <p>3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。助贷网有权对会员的权限设计进行变更。</p>\n" +
            " <p>3.2 用户只能按照注册要求使用真实姓名。用户有义务保证密码和帐号的安全，用户利用该密码和帐号所进行的一切活动引起的任何损失或损害，由用户自行承担全部责任，本站不承担任何责任。如用户发现帐号遭到未授权的使用或发生其他任何安全问题，应立即修改帐号密码并妥善保管，如有必要，请通知本站。因黑客行为或用户的保管疏忽导致帐号非法使用，本站不承担任何责任。</p>\n" +
            " <p class=\"fz18\">四、使用规则</p>\n" +
            ...
            " <p class=\"fz18\">六、版权声明</p>\n" +
            " <p>6.1 本站的文字、图片、音频、视频等版权均归深圳前海小微贷发展有限公司享有或与作者共同享有，未经本站许可，不得任意转载。</p>\n" +
            " <p>6.2 本站特有的标识、版面设计、编排方式等版权均属深圳前海小微贷发展有限公司享有，未经本站许可，不得任意复制或转载。</p>\n" +
            " <p class=\"fz18\">七、责任声明</p>\n" +
            " <p>7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，助贷网对此不承担任何责任。</p>\n" +
            ...
            " <p>8.3 本协议解释权及修订权归深圳前海小微贷发展有限公司所有。</p>\n" +
            "</div>\n";
    ...
    private void initView() {
        ...
        String text = StringUtils.getString(is);
        tvProtocol.setText(Html.fromHtml(content));
