 ...
 */
public class ConsumeListRVAdapter extends RecyclerView.Adapter<ConsumeListRVAdapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        if (position == 0) {
            ...
            holder.tvItemTime.setText("分配时间");
            holder.tvItemAmount.setText("分配客户");
            holder.tvItemStatus.setText("客户手机");
            holder.tvItemBalance.setText("消费金额");
     ...
     * @param datas 展示的数据
     */
    public ConsumeListRVAdapter(Context context, List<RechargeRecordBean> datas) {
        this.datas = datas;
